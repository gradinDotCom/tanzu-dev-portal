...
![Tanzu Edition reference design diagram](images/tkg-aws-overview.png)
...
![TKG AWS network overview diagram](images/tkg-aws-network-overview.png)
...
![TKG on AWS with Single VPC and Multiple Availability Zones diagram](images/tkg-aws-single-vpc-multi-az.jpg)
...
![TKG on AWS with Multiple VPCs and Multiple Availability Zones diagram](images/tkg-aws-multi-vpc-multi-az.jpg)
...
![TKG on AWS with Segregated VPCs for control plane and workloads diagram](images/tkg-aws-multi-vpc-multi-az-separated-control-plane-and-workloads.jpg)
...
![Tanzu Mission Control Register Management cluster](images/tmc-register-management-cluster.jpg)
...
![Tanzu Mission Control attach cluster](images/tmc-attach-cluster-screen.png)
...
![TKG on AWS ingress with Contour diagram](images/tkg-aws-ingress-contour.jpg)
...
Tanzu Observability provides various out-of-the-box dashboards. You can customize the dashboards for your particular deployment. For information on how to customize Tanzu Observability dashboards for Tanzu for Kubernetes Operations, see../deployment-guides/tko-to-customized-dashboard.md($resources/tko-to-customized-dashboard.md).
...
![Tanzu Observability CPU utilization dashboard](images/tanzu-observability-cpu-dashboard.png)

![Tanzu Observability availability dashboard](images/tanzu-observability-availability-dashboard.png)
...
For instructions on how to deploy this reference design, see../deployment-guides/tko-aws.md($resources/tko-aws.md).
