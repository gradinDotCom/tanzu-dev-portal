...
![Diagram of TKO using vSphere with Tanzu Reference Architecture](images/TKO-VWT-Reference-Design.jpg)
...
- **VM Class in vSphere with Tanzu:** A VM class is a template that defines CPU, memory, and reservations for VMs. VM classes are used for VM deployment in a Supervisor Namespace. VM classes can be used by standalone VMs that run in a Supervisor Namespace and by VMs hosting a Tanzu Kubernetes cluster.
  ...
  VM classes in vSphere with Tanzu are broadly categorized into two groups.
	...
	![Screenshot of default VM Classes in vSphere with Tanzu](images/tko-vwt01.jpg)
...
![Diagram of vSphere with Tanzu Architecture](images/tko-vwt03.png)
...
![Diagram of Supervisor Cluster Architecture](images/tko-vwt04.jpg)
...
![vSphere Namespace](images/tko-vwt05.png)
...
![Diagram of network reference design](images/tko-vwt08.jpg)
...
![Screenshot of the vCenter integrated Workload Management page](images/tko-vwt09.jpg)
...
![Screenshot of the vCenter UI for configuring vSphere with Tanzu](images/tko-vwt10.jpg)
...
![Screenshot of Harbor Registry UI](images/tko-vwt12.png)
...
For instructions on how to deploy this reference design, see../deployment-guides/tko-on-vsphere-with-tanzu.md($resources/tko-on-vsphere-with-tanzu.md).
