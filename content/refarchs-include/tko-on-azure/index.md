...
![Tanzu Standard component set](images/tkg-overview-azure.png)
...
![TKG installer user interface](images/image004.png)
...
![Tanzu Mission Control attach cluster screen](images/tmc-attach-cluster-screen.png)
...
For instructions on how to deploy this reference design, see../deployment-guides/tko-on-azure.md($resources/tko-on-azure.md).
