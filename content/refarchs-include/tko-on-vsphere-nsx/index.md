...
![Tanzu Edition reference architecture diagram](images/tkgm-diagram.png)
...
![TKG with NSX Data Center Networking general network layout 01](images/tko-on-vsphere-nsxt-3.png)
...
![TKG with NSX Data Center Networking general network layout 02](images/tko-on-vsphere-nsxt-2.png)
...
![Tanzu for Kubernetes Grid installer welcome screen](images/tko-on-vsphere-nsxt-4.png)
...
![Tanzu for Kubernetes Grid installer UI for vSphere](images/tko-on-vsphere-nsxt-5.png)
...
![NSX Advanced Load Balancing capabilities for VMware Tanzu](images/tko-on-vsphere-nsxt-6.png)
...
![Harbor Container Registry](images/tko-on-vsphere-nsxt-7.png)
...
![TKG Monitoring](images/tko-on-vsphere-nsxt-8.png)
...
You can also monitor your Tanzu Kubernetes Grid clusters with [Tanzu Observability](https://docs.vmware.com/en/VMware-Tanzu-Observability/index.html) which is a SaaS offering by VMware. Tanzu Observability provides various out-of-the-box dashboards. You can customize the dashboards for your particular deployment. For information on how to customize Tanzu Observability dashboards for Tanzu for Kubernetes Operations, see../deployment-guides/tko-to-customized-dashboard.md($resources/tko-to-customized-dashboard.md).
...
For instructions on how to deploy this reference design, see../deployment-guides/tko-on-vsphere-nsxt.md($resources/tko-on-vsphere-nsxt.md).
