...
![Tanzu for Kubernetes Grid network layout](images/tko-on-vsphere-network-architecture.jpg)
...
![Tanzu for Kubernetes Grid network layout](images/3-network-architecture.jpg)
...
![NSX Advanced Load Balancing capabilities for VMware Tanzu](images/tko-on-vsphere-vds-6.png)
...
![Harbor Container Registry](images/tko-on-vsphere-vds-7.png)
...
![Monitoring components interaction in a cluster](images/images-monitoring-stack.png)
...
![Tanzu for Kubernetes Grid installer welcome screen](images/tko-on-vsphere-vds-4.png)
...
![Tanzu for Kubernetes Grid installer UI for vSphere](images/tko-on-vsphere-vds-5.png)
...
For instructions on how to deploy this reference design, see../deployment-guides/tko-on-vsphere.md($resources/tko-on-vsphere.md).
